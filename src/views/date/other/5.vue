	...
	<div id="Dother5">
		...
		<div id="main">
			<div class="nav-article">
				...
				<span> &gt; </span>
				<router-link :to="{name: 'Dother5'}">idea快捷键</router-link>
			</div>
				...
				<div class="data-classify-right">
					...
					<div class="skip-top">
						<div class="previouPage">
							<router-link :to="{name:'Dother4'}"><img class="img-l"
																	 src="https://gitee.com/ZRX001/gallery/raw/master/gallery/arrow-left.png"
																	 alt="左箭头"> <span
								class="span-txt">原码、反码、补码三者之间的关系</span>
							</router-link>
						</div>
					</div>
					...
					<div class="article">
						...
						<p><span class="published">发布时间：2020-11-23-1</span></p>
						<h1>idea快捷键</h1>
						<h3>一、Ctrl 快捷键</h3>
						<pre><code>Ctrl + F    在当前文件进行文本查找
Ctrl + R    在当前文件进行文本替换
Ctrl + Z    撤销
...
Ctrl + P    方法参数提示显示
						...
						<pre><code>Ctrl + Q    光标所在的变量 / 类名 / 方法名等上面（也可以在提示补充的时候按），显示文档内容
...
Ctrl + /    释光标所在行代码，会根据当前不同文件类型使用不同的注释符号
						...
						<pre><code>Ctrl + [    移动光标到当前所在代码的花括号开始位置
...
Alt + Insert 代码自动生成，如生成对象的 set / get 方法，构造函数，toString() 等
						...
						<pre><code>Alt + 左方向键     切换当前已打开的窗口中的子视图，比如 Debug 窗口中有 Output、Debugger 等子视图，用此快捷键就可以在子视图中切换
...
Alt +1,2,3...9    显示对应数值的选项卡，其中 1 是 Project 用得最多
						...
						<p>&nbsp;</p>
						<h3>三、Shift 快捷键</h3>
						<pre><code>Shift + F1   如果有外部文档可以连接外部文档
...
Shift + 滚轮前后滚动   当前文件的横向滚动轴滚动
						...
						<p>&nbsp;</p>
						<h3>四、Ctrl + Alt 快捷键</h3>
						<pre><code>Ctrl + Alt + L   格式化代码，可以对当前文件和整个包目录使用
...
Ctrl + Alt + 后方向键    在查找模式下，跳到下个查找的文件
						...
						<p>&nbsp;</p>
						<h3>五、Ctrl + Shift 快捷键</h3>
						<pre><code>Ctrl + Shift + F  根据输入内容查找整个项目 或 指定目录内文件
...
Ctrl + Shift + T  对当前类生成单元测试类，如果已经存在的单元测试类则可以进行选择
						...
						<pre><code>Ctrl + Shift + C  复制当前文件磁盘路径到剪贴板
...
Ctrl + Shift + -  折叠所有代码
						...
						<pre><code>Ctrl + Shift + F7    高亮显示所有该选中文本，按 Esc 高亮消失
...
Ctrl + Shift + 左键单击   把光标放在某个类变量上，按此快捷键可以直接定位到该类中
						...
						<pre><code>Ctrl + Shift + 左方向键    在代码文件上，光标跳转到当前单词 / 中文句的左侧开头位置，同时选中该单词 / 中文句
Ctrl + Shift + 右方向键    在代码文件上，光标跳转到当前单词 / 中文句的右侧开头位置，同时选中该单词 / 中文句
Ctrl + Shift + 前方向键    光标放在方法名上，将方法移动到上一个方法前面，调整方法排序
Ctrl + Shift + 后方向键    光标放在方法名上，将方法移动到下一个方法前面，调整方法排序
</code></pre>
						<p>&nbsp;</p>
						<h3>六、Alt + Shift 快捷键</h3>
						<pre><code>Alt + Shift + N     选择 / 添加 task
...
Alt + Shift + 后方向键  移动光标所在行向下移动
						...
						<p>&nbsp;</p>
						<h3>七、Ctrl + Shift + Alt 快捷键</h3>
						<pre><code>Ctrl + Shift + Alt + V   无格式黏贴
